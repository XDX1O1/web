...
px => use it for font-size
pt => use it for font-size
...
# 3. Subsquent Sibling (Only Sibling that have the same parent, it will not effect if sibling before current element)
h2~p {
  font-weight: bold;
  color: blue;
}

# 4. Next Sibling (Only Effect Imidiate Sibling)
h2+p {
  font-weight: bold;
  color: blue;
}
...
###############################
##### 012. PSUEDO CLASSES
Targer element based on its state or relationship to another element
...
youu dont need to specify width/height if you want to fill the space grid cell

// AUTOMATIC COLUMNS/ROWS GRID //
grid-auto-columns: 1fr 1fr;
grid-auto-rows: 300px;
the reason why you dont need to use grid-template-rows because it will adjust automatically with columns
